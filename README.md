...
#### `.gitignore` — Sensitive file patterns (shared)

`.gitignore` must exist and cover the following patterns to prevent accidental credential exposure:
...
#### `secrets scan` — Hardcoded secrets (shared)
